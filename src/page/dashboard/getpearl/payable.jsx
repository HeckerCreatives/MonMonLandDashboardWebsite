    ...
    useEffect(() => {
        ...
        .then(data => {
          if(data.message === "success"){
            ...
            setMonsterGemFarm(mgfarm)
            const mgunilvl = (data.data.complanmerchandise + data.data.complantools + data.data.complancosmetics)
            setMonsterGemUnilevel(mgunilvl)
            setUnilevelPayin(data.data.complanpayin)
            setLeaderboard(data.data.leaderboard)
            const coh = (mc + mgfarm + mgunilvl + data.data.complanpayin + data.data.leaderboard)
            setCashonhand(coh)
          }
        })
